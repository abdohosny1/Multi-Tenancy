...
namespace Multi_Tenancy.Data
{
    public class AppDbContext : DbContext
    {
        public string TenantId { get; set; }
        private readonly ITenanetServices _tenantService;

        public AppDbContext(DbContextOptions options, ITenanetServices tenantService) : base(options)
        {
